    ...
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-header d-flex flex-column flex-md-row align-items-md-center gap-2">
                ...
                <div>
                    <button id="btnReloadExpired" class="btn btn-outline-secondary btn-sm">Reload / Clear Filters</button>
                </div>
            </div>
            <div class="card-body">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const table = $('#usmmExpiredTable').DataTable({
                ...
                initComplete: function() {
                    $('#usmmExpiredTable thead tr.filters input').on('keyup change', function() {
            ...
            btnReload.addEventListener('click', () => {
                $('#usmmExpiredTable thead tr.filters input').each(function() {
                    this.value = '';
