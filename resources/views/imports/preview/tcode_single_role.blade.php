...
@section('content')
    <div class="container-fluid">
        <h1>Preview Single Roles & Tcode</h1>
        ...
        <!-- Datatable -->
        <table id="singleTcodeTable" class="table table-bordered display responsive nowrap">
        </table>
        ...
        <form id="confirm-form" action="{{ route('tcode_single_role.confirm') }}" method="POST">
            @csrf
            <button type="submit" class="btn btn-success">Confirm Import</button>
            <a href="{{ route('tcode_single_role.upload') }}" class="btn btn-secondary">Cancel</a>
        </form>
        ...
        @if (session('success'))
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="{{ route('tcode_single_role.upload') }}" class="btn btn-primary">Back to Upload Page</a>
