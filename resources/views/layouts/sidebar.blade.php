...
<div class="sidebar-scroll">
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        @can('Super Admin')
            ...
            <div class="dropdown mt-2">
                @php
                    $isRawSectionActive = request()->routeIs('middle_db.raw.uam*', 'middle_db.view.uam*');
                @endphp
        ...
        @can('data.view')
            ...
            <div class="dropdown">
                ...
                <div
                    ...
                    {{-- 
                    <li>
                        <a href="{{ route('compare.unit_kerja') }}"
                            class="nav-link {{ request()->routeIs('compare.unit_kerja') ? 'active' : 'text-white' }}">
                            <i class="bi bi-file-diff me-2"></i> Compare Unit Kerja
                        </a>
                    </li> --}}
                    ...
                    <div
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dynamic_upload.upload', ['module' => 'master_nik']) }}"
                                class="nav-` {{ request()->route('module') === 'master_nik' ? 'active' : 'text-white' }}">
